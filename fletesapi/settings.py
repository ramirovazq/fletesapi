...
URL_BASE_API=os.environ['URL_BASE_API']
...
URL_API_LIME=os.environ['URL_API_LIME']
USERNAME_API_LIME=os.environ['USERNAME_API_LIME']
PASSWD_API_LIME=os.environ['PASSWD_API_LIME']
ID_DEMO_LIME=os.environ["ID_DEMO_LIME"]
